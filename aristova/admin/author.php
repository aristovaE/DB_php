...
echo "<script>
		function myConf()
		{
			return(confirm('Вы уверены, что хотите удалить данного автора?'));	
		}
	</script>";
echo "<table border>";
   ...
   echo "<tr>
	   ...
	   <td>".$el['fio_17']."
		   ...
		   <td>".$el['rating_17']."
		   		   ...
		   		   <td id='udred'><a href = author.php?har=".$el["id_17"]." onclick='return(myConf())'>удалить</a></td>
		    <td id='udred'><a href = author.php?hor=".$el["id_17"].">изменить</a></td>
...
<form method="GET">
	<H4> НОВЫЙ АВТОР </H4>
	<br> Фамилия И.О. : <input type = "text"  name = "fio" size = 30><br>
